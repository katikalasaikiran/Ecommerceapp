...
<NavLink to='/' className='hover:bg-pink-700 flex felx-col items-center gap-1 '>
    <p>HOME</p>
    
</NavLink>
<NavLink to='/collection' className=' hover:bg-pink-700 flex felx-col items-center gap-1 '>
    <p>COLLECTION</p>
</NavLink>
<NavLink to='/about' className='hover:bg-pink-700 flex felx-col items-center gap-1 '>
    <p>ABOUT</p>
</NavLink>
<NavLink to='/contact' className='hover:bg-pink-700 flex felx-col items-center gap-1 '>
    <p>CONTACT</p>
</NavLink>
       </ul>
...
<p className='absolute right-[-5px] bottom-[-5px] w-4 text-center leading-4 bg-black text-white ascept-square rounded-full text-[8px]'>{getCartCount()}</p>
        </Link>
        <img onClick={()=>{setVisible(true)}} src={assets.menu_icon} className='w-5 cursor-pointer sm:hidden' alt="" />
       </div>
       {/* sildebar for a small screens */}
